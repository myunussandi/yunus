...
/////////////////
const BotName = 'YUNUS☄'; 
const instagram = 'https://instagram.com/myunussandi'; 
const telegram = 'https://t.me/myunussandi'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
//const grupch1 = 'https://chat.whatsapp.com/KWLPAkYGiTNIHPrw5qyxCA'; 
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@myunussandi')
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ig:@myunussandi`)
})
